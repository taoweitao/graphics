...
s4:scale(50, 50, 50)
s4:translate(-25, -25, -25)
s4:rotate('y', 45)
s4:rotate('x', 30)
s4:translate(100, 40, 200)
...
gr.render(scene_root, 'objective4.png', 256, 256,
