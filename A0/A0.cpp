...
void A0::guiLogic()
{
	...
	ImGui::Begin("Shape Properties", &showDebugWindow, ImVec2(100,100), opacity,
		...
		// Retrieve green color component from slider and store in the first element of m_shape_color.
		...
		// Retrieve rotation angel from slider and store in the m_shape_rotation
